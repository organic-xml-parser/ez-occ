...
from ezocc.alg.joinery.box_segment_joiner import BoxSegmentJoiner
from ezocc.occutils_python import WireSketcher
from ezocc.part_manager import PartFactory, NoOpPartCache


class BoxSegmentJoinerTest(unittest.TestCase):
    ...
    def test_join_squares(self):
        ...
        joint = BoxSegmentJoiner().get_joint(face_a, face_b)
